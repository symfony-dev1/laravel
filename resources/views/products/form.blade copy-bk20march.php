                                    ...
                                    <div class="card-body">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="">
                                                ...
                                                <label for="product_slug" class="col-form-label text-md-right">Slug : </label><span class="product-slug">@if(isset($product)) @if($product->status == 3)<a href="{{route('products.show', $product->id)}}" target="_blank"> https://caregiverjobssandiego.com/{{ $product->slug }} </a> @else <a href="{{route('product.show', $product->slug)}}" target="_blank"> https://caregiverjobssandiego.com/preview/{{ $product->slug }} </a> @endif <span class="edit-button" onclick="editslug()">Edit</span> @endif</span>
                                                                ...
                                                                <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <input class="form-control w-25 " type="text" name="price" value="@if(isset($product))  {{$product->price}} $else {{old('price')}} @endif" id=" price" placeholder="Regular Price">
