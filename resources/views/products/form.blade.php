...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="ml-2"> @if(isset($product))
                    {{ __('Edit Product') }}
                    @else
                    {{ __('Create Product') }}
                    @endif
                ...
                <div class="back-btn bredcrumb">
                    <a href="{{route('products.index')}}">Products</a><i class="fas fa-chevron-right"></i><a href="#"> @if(isset($product))
                        {{ __('Edit Product') }}
                        @else
                        {{ __('Create Product') }}
                        @endif</a>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    <form method="POST" action="{{ route('products.store') }}" id="products" enctype="multipart/form-data">
                        @csrf
                        <input id="edit_id" type="hidden" class="form-control" name="edit_id" @if(isset($product)) value="{{ $product->id }}" @else value='' @endif>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="">
                                                ...
                                                <label for="product_slug" class="col-form-label text-md-right">Slug : </label><span class="product-slug">@if(isset($product)) @if($product->status == 3)<a href="{{config("app.fronted_url")}}/product/{{ $product->slug }}" target="_blank"> {{config("app.fronted_url")}}/product/{{ $product->slug }} </a> @else <a href="{{config("app.fronted_url")}}/product/{{ $product->slug }}" target="_blank"> {{config("app.fronted_url")}}/product/{{ $product->slug }} </a> @endif <span class="edit-button" onclick="editslug()">Edit</span> @endif</span>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="">
                                                <textarea id="product_description" class="form-control tinymce-editor" name="product_description">
                                                    @if( isset( $product ) ){{ $product->description }}@else{{ old('description') }}@endif
                                                </textarea>
                                                            ...
                                                            <ul class="nav nav-tabs" id="pills-tab" role="tablist">
                                                                ...
                                                                <li class="nav-item">
                                                                    <select class="form-control" name="product_type" id="product_type">
                                                                        <option value="0" @if(isset($product) && $product->product_type==0) selected $else '' @endif>Simple Product</option>
                                                                        <option value="1" @if(isset($product) && $product->product_type==1) selected $else '' @endif>Variable Product</option>
                                                                    </select>
                                                                </li>
                                                            </ul>
                                                                ...
                                                                <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <input class="form-control w-25 " type="text" name="price" @if(isset($product)) value="{{$product->price}}" $else value="{{old('price')}}" @endif id=" price" placeholder="Regular Price">
                                                                            ...
                                                                            <input class="form-control w-25 " type="text" name="sale_price" @if(isset($product)) value="{{$product->sales_price}}" $else value="{{old('sales_price')}}" @endif id="sale_price" placeholder="Sale Price">
                                                                            <div class="row" id="sale_dates" style="display: none">
                                                                                <div class="col">
                                                                                    <label class="mt-3 " for="start_date">Sale Start Date</label>
                                                                                    <input class="form-control" type="date" name="start_date" id="start_date" @if(isset($product)) value="{{ $product->start_date }}" @else value="{{ old('start_date') }}" @endif>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <label class="mt-3 " for="end_date">Sale End Date</label>
                                                                                    <input class="form-control" type="date" name="end_date" id="end_date" @if(isset($product)) value="{{ $product->sku }}" @else value="{{ old('sku') }}" @endif>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="tab-pane fade " id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <input class="form-control w-25 " type="text" name="sku" @if(isset($product)) value="{{ $product->sku }}" @else value="{{ old('sku') }}" @endif id="sku" placeholder="SKU.">
                                                                            <label class="mt-3" for="stock">Stock Quantity</label>
                                                                            <input class="form-control w-25 " type="text" name="stock" @if(isset($product)) value="{{ $product->stock }}" @else value="{{ old('stock') }}" @endif id="stock" placeholder="Stock">
                                                                            ...
                                                                            <select class="form-control  w-25" name="allow_backorders" id="allow_backorders">
                                                                                <option value="1" @if(isset($product) && $product->allow_backorders==1) "selected" @else "" @endif>Yes</option>
                                                                                <option value="0" {{ isset($product) && $product->allow_backorders==0 ? "selected" : "" }}>No</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane fade removeActive" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <input class="form-control w-25 " type="text" name="weight" @if(isset($product)) value="{{ $product->weight }}" @else value="{{ old('weight') }}" @endif id="weight" placeholder="Weight">
                                                                            <label class="mt-3" for="stock">Dimensions(cm)</label>
                                                                            <div class="row w-50">
                                                                                <div class="col-md-4">
                                                                                    <input class="form-control" type="text" name="length" @if(isset($product)) value="{{ $product->dim_length }}" @else value="{{ old('length') }}" @endif id="length" placeholder="Length">
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <input class="form-control" type="text" name="width" @if(isset($product)) value="{{ $product->dim_width }}" @else value="{{ old('width') }}" @endif id="width" placeholder="Width">
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <input class="form-control" type="text" name="height" @if(isset($product)) value="{{ $product->dim_height }}" @else value="{{ old('height') }}" @endif id="height" placeholder="Height">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="row mt-3">
                                                                                ...
                                                                                <div id="selected_attributes_and_terms"></div>
                                                                            </div>
                                                                            <div id="variants">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="">
                                                <textarea id="product_short_description" class="form-control tinymce-editor" name="product_short_description">
                                                @if( isset( $product ) ){{ $product->short_description }}@else{{ old('short_description') }}@endif
                                            </textarea>
                                                <span id="ck_description" style="color: red"></span>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-category">
                                            <div class="category">
                                                ...
                                                @php $sp = ''; @endphp
                                                <div class="">
                                                    <input type="checkbox" value="{{ $category->id }}" name="categories[]" @if (isset($product) && $product->categories->contains('id',$category->id)) checked @endif> {{ $category->title }} <span class="delete-category" data-id="{{ $category->id }}" title="Delete"><i class="fa fa-minus icon-minus"></i></span>
                                                </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-brand">
                                            <div class="brand">
                                                ...
                                                @php $sp = ''; @endphp
                                                <div class="">
                                                    <input type="checkbox" value="{{ $brand->id }}" name="brands[]" @if (isset($product) && $product->brands->contains('id',$brand->id)) checked @endif> {{ $brand->title }} <span class="delete-brand" data-id="{{ $brand->id }}" title="Delete"><i class="fa fa-minus icon-minus"></i></span>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-image">
                                            ...
                                            <img class="add-post-img" src="{{ asset('/uploads/products/'.$product->product_image) }}">
                                            <div class='imgalt'>
                                                <label for="alt" class="col-form-label text-md-right">
                                                    {{ __('Alt') }}
                                                </label>
                                                <input type="text" name='imgalt' class="form-control" @if(isset($product)) value="{{ $product->img_alt }}" @endif placeholder="Enter alt for image">
                                            </div>
                                            <div class='caption'>
                                                <label for="caption" class="col-form-label text-md-right">
                                                    {{ __('Caption') }}
                                                </label>
                                                <textarea name='caption' class="form-control" placeholder="Enter caption for image">@if(isset($product)){{$product->img_caption}}@endif</textarea>
                                            </div>
                                            @else
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-tag">
                                            <div class="tag">
                                                ...
                                                @php $sp = ''; @endphp
                                                <div class="">
                                                    <input type="checkbox" value="{{ $tag->id }}" name="tags[]" @if (isset($product) && $product->tags->contains('id',$tag->id)) checked @endif> {{ $tag->title }} <span class="delete-tag" data-id="{{ $tag->id }}" title="Delete"><i class="fa fa-minus icon-minus"></i></span>
                                                </div>
                                                @endforeach
                                                @endif
                                            </div>
...
<script type="text/javascript">
    ...
    function getslug() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var html = '{{config("app.fronted_url")}}/product/' + response + ' @if(!isset($product)) <span class="edit-button" onclick="editslug()">Edit</span> @endif';
    ...
    function editslug() {
        ...
        var html = '{{config("app.fronted_url")}}/product/<input name="edit_slug" id="edit-slug" value="' + slug[0] + '"> <span onclick="updateslug()" class="edit-button">Update</span> <span  onclick="cancelslug()" class="edit-button">Cancel</span>';
        $(".product-slug").html(html);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response == 'success') {
                    ...
                    var html = '{{config("app.fronted_url")}}/product/' + update_slug + ' <span class="edit-button" onclick="editslug()">Edit</span>';
                    $(".product-slug").html(html);
                    ...
                    var html = '/{{config("app.fronted_url")}}/product/ <input  name="edit_slug" id="edit-slug" value="' + update_slug + '"> <span onclick="updateslug()" class="edit-button">Update</span> <span onclick="cancelslug()" class="edit-button">Cancel</span>';
                    $(".product-slug").html(html);
